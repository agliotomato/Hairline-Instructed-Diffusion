python test_sd3_sonic_hybrid_v2.py \
  --image_path "test_data/bald_images/test1.png" \
  --mask_path "test_data/semantic_masks/test1.png" \
  --output_path "results/native2/test1_1.png" \
  ...
  --adapter_path "output/tiny_adapter_v3_checkpoints/tiny_adapter_native_final.pth" \
  --hidden_channels 256
...
python test_sd3_sonic_hybrid_v2.py \
  --image_path "test_data/bald_images/test1.png" \
  --mask_path "test_data/semantic_masks/test1.png" \
  --output_path "results/native2/test1_2.png" \
...
python test_sd3_sonic_hybrid_v2.py \
  --image_path "test_data/bald_images/test1.png" \
  --mask_path "test_data/semantic_masks/test1.png" \
  --output_path "results/native2/test1_3.png" \
...
python test_sd3_sonic_hybrid_v2.py \
  --image_path "test_data/bald_images/test1.png" \
  --mask_path "test_data/semantic_masks/test1.png" \
  --output_path "results/native2/test1_4.png" \
...
python test_sd3_sonic_hybrid_v2.py \
  --image_path "test_data/bald_images/test1.png" \
  --mask_path "test_data/semantic_masks/test1.png" \
  --output_path "results/native2/test1_5.png" \
