python test_sd3_native_adapter_inference.py \
  --image_path "test_data/bald_images/test2.png" \
  --mask_path "test_data/segmantic_masks/test2.png" \
  --output_path "results/native2/test2_1.png" \
...
python test_sd3_native_adapter_inference.py \
  --image_path "test_data/bald_images/test2.png" \
  --mask_path "test_data/segmantic_masks/test2.png" \
  --output_path "results/native2/test2_3.png" \
...
python test_sd3_native_adapter_inference.py \
  --image_path "test_data/bald_images/test2.png" \
  --mask_path "test_data/segmantic_masks/test2.png" \
  --output_path "results/native2/test2_4.png" \
...
python test_sd3_native_adapter_inference.py \
  --image_path "test_data/bald_images/test2.png" \
  --mask_path "test_data/segmantic_masks/test2.png" \
  --output_path "results/native2/test2_5.png" \
