...
def encode_prompt(
    ...
    text_embeddings = text_embeddings.repeat(num_images, 1, 1)
    ...
    if guidance_scale > 1.0:
        ...
        uncond_embeddings = uncond_embeddings.repeat(num_images, 1, 1)
...
def main():
    parser = argparse.ArgumentParser(description="Inference for the hairline-conditioned UNet.")
    ...
    latents = latents.repeat(args.num_samples, 1, 1, 1)
